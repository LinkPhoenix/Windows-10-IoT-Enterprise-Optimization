@ECHO OFF
@Echo Move to "High performance" profile
POWERCFG -SETACTIVE SCHEME_MIN
@Echo Delete profile "Balanced" and "High performance"
POWERCFG /D 381b4222-f694-41f0-9685-ff5bb260df2e
POWERCFG /D a1841308-3541-4fab-bc81-f71556f20b4a
@Echo Config the "High performance" profile
...
@Echo Stop and sleep button turn off the PC
set index=3
...
@Echo ===== No password request for standby output
...
@Echo ===== USB settings/USB selective suspend setting
...
@Echo ===== Display/Dim display after
