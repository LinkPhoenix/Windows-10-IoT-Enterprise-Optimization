...
REG ADD "HKLM\SOFTWARE\Microsoft\Windows Embedded\EmbeddedLogon" /v "BrandingNeutral" /t "REG_DWORD" /d "17" /f
:: Hides the whole process of auto-connection
REG ADD "HKLM\SOFTWARE\Microsoft\Windows Embedded\EmbeddedLogon" /v "HideAutoLogonUI" /t "REG_DWORD" /d "1" /f
:: Disable the "First Logon Animation"
REG ADD "HKLM\SOFTWARE\Microsoft\Windows Embedded\EmbeddedLogon" /v "HideFirstLogonAnimation" /t "REG_DWORD" /d "1" /f
